...
public class Customer {
    ...
    public Customer(int customerUID, Dealer myDealer, List<Sales> mySales, List<Car> carInterests, CustomerType type, int customerId, String name, String email, String tel, String addr, String job, String birth, LocalDateTime createdAt, LocalDateTime updatedAt) {
